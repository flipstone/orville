...
virusDiscoveredAtField =
  O.localTimeField "discovered_at" `O.withConversion`
  O.convertSqlType (Time.utcToLocalTime Time.utc . unVirusDiscoveredAt) (VirusDiscoveredAt . Time.localTimeToUTC Time.utc)
