...
@since 1.1.0.0
-}
aggregateExpression :: FunctionName -> Maybe AggregateOptionExpr -> NEL.NonEmpty ValueExpression.ValueExpression -> Maybe OrderBy.OrderByClause -> Maybe WhereClause.WhereClause -> ValueExpression.ValueExpression
aggregateExpression function mbAggOption parameters mbOrderByClause mbWhereClause =
  let
    fnCall =
...
@since 1.1.0.0
-}
aggregateStarExpression :: FunctionName -> Maybe WhereClause.WhereClause -> ValueExpression.ValueExpression
aggregateStarExpression function mbWhereClause =
  let
...
@since 1.1.0.0
-}
aggregateWithinGroupExpression :: FunctionName -> [ValueExpression.ValueExpression] -> OrderBy.OrderByClause -> Maybe WhereClause.WhereClause -> ValueExpression.ValueExpression
aggregateWithinGroupExpression function parameters orderByClause mbWhereClause =
  let
    within =
