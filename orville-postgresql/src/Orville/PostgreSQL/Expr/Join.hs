...
{- |
  A convenience function for constructing joins want to track the tables to be
  joined in a list or simply want to avoid using the '(&)' operator. The tables
  will be joined in a left associative manner, matching the associativity of the
