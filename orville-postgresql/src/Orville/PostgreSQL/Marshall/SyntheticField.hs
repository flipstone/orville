...
orderBySyntheticField =
  Expr.orderByColumnName . Expr.qualifiedTo . Expr.aliasQualifyColumn Nothing . Expr.fromIdentifier . Expr.identifierFromBytes . aliasNameToByteString . syntheticFieldAlias
