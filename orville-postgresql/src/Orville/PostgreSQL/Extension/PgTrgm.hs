...
trigramSimilaritySyntheticField colname compareVal fieldAlias =
  Marshall.syntheticField
    (trigramSimilarity (Expr.columnReference . Expr.qualifiedTo $ Expr.aliasQualifyColumn Nothing colname) compareVal)
    fieldAlias
    Marshall.double
...
trigramWordSimilaritySyntheticField colname compareVal fieldAlias =
  Marshall.syntheticField
    (trigramWordSimilarity (Expr.columnReference . Expr.qualifiedTo $ Expr.aliasQualifyColumn Nothing colname) compareVal)
    fieldAlias
    Marshall.double
...
trigramStrictWordSimilaritySyntheticField colname compareVal fieldAlias =
  Marshall.syntheticField
    (trigramStrictWordSimilarity (Expr.columnReference . Expr.qualifiedTo $ Expr.aliasQualifyColumn Nothing colname) compareVal)
    fieldAlias
    Marshall.double
