...
pgCatalogTests :: Orville.ConnectionPool -> Tasty.TestTree
pgCatalogTests pool =
  Tasty.testGroup
    "PgCatalog"
    [ TastyHH.testProperty
        "Can query the pg_class table to find out about a table"
        (prop_queryPgClass pool)
    , TastyHH.testProperty
        "Can query the pg_attribute table to find out about a column"
        (prop_queryPgAttribute pool)
    , TastyHH.testProperty
        "Can query the pg_attrdef table to find out about a default value"
        (prop_queryPgAttributeDefault pool)
    , TastyHH.testProperty
        "Can query the pg_constraint table to find out about a constraint"
        (prop_queryPgConstraint pool)
    , TastyHH.testProperty
        "Can query the pg_trigger table to find out about a trigger"
        (prop_queryPgTrigger pool)
    , TastyHH.testProperty
        "Can query the pg_proc table to find out about a proc"
        (prop_queryPgProc pool)
    , TastyHH.testProperty
        "Can describe relations from different schemas at once"
        (prop_describeDatabaseRelations pool)
    ]

prop_queryPgClass :: Orville.ConnectionPool -> HH.Property
prop_queryPgClass pool = Property.singletonProperty $ do
...
prop_queryPgAttribute :: Orville.ConnectionPool -> HH.Property
prop_queryPgAttribute pool = Property.singletonProperty $ do
...
prop_queryPgAttributeDefault :: Orville.ConnectionPool -> HH.Property
prop_queryPgAttributeDefault pool = Property.singletonProperty $ do
  let
    fieldDefWithDefault =
...
prop_queryPgConstraint :: Orville.ConnectionPool -> HH.Property
prop_queryPgConstraint pool = Property.singletonProperty $ do
...
prop_queryPgTrigger :: Orville.ConnectionPool -> HH.Property
prop_queryPgTrigger pool = Property.singletonProperty $ do
  let
    triggerFunctionName =
...
prop_queryPgProc :: Orville.ConnectionPool -> HH.Property
prop_queryPgProc pool = Property.singletonProperty $ do
  let
    procFunctionName =
...
prop_describeDatabaseRelations :: Orville.ConnectionPool -> HH.Property
prop_describeDatabaseRelations pool = Property.singletonProperty $ do
  let
    relationsToDescribe =
