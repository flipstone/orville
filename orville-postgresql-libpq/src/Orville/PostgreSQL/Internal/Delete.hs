...
{- | Represents an @INSERT@ statement that can be executed against a database. An 'Delete' has a
...
{- |
  Builds an 'Delete' that will delete all of the writeable columns described in the
